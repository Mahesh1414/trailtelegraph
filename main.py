...
async def bio(client, message):
    await tgraph.copy_message(chat_id=message.from_user.id, from_chat_id=-1001430997268, message_id=2),
    await tgraph.copy_message(chat_id=message.from_user.id, from_chat_id=-1001430997268, message_id=3)
